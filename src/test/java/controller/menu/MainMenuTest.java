...
class MainMenuTest {
    ...
    public void menuExit() {
        ...
        new LoginMenu().run("user login -u menuExitT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
        ...
        assertEquals(Responses.successfulUserCreation + System.lineSeparator() + Responses.successfulLogin + System.lineSeparator() + "Login Menu" + System.lineSeparator(), outputStreamCaptor.toString());
    }

    @Test
    public void menuShow() {
        new LoginMenu().run("user create -u menuShowT1yl0rSw1ftW4$B0rnIn1989 -n menuShowT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
        new LoginMenu().run("user login -u menuShowT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
    ...
    public void menuEnterDuel() {
        ...
        new LoginMenu().run("user login -u menuEnterDuelT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
        ...
        assertEquals(Responses.successfulUserCreation + System.lineSeparator() + Responses.successfulLogin + System.lineSeparator() + "Duel Menu" + System.lineSeparator(), outputStreamCaptor.toString());
    }
    ...
    public void menuEnterDeck() {
        ...
        new LoginMenu().run("user login -u menuEnterDeckT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
        ...
        assertEquals(Responses.successfulUserCreation + System.lineSeparator() + Responses.successfulLogin + System.lineSeparator() + "Deck Menu" + System.lineSeparator(), outputStreamCaptor.toString());
    }
    ...
    public void menuEnterProfile() {
        ...
        new LoginMenu().run("user login -u menuEnterProfileT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
    ...
    public void menuEnterShop() {
        ...
        new LoginMenu().run("user login -u menuEnterShopT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
        ...
        assertEquals(Responses.successfulUserCreation + System.lineSeparator() + Responses.successfulLogin + System.lineSeparator() + "Shop Menu" + System.lineSeparator(), outputStreamCaptor.toString());
    }
    ...
    public void menuEnterImport() {
        ...
        new LoginMenu().run("user login -u menuEnterImportT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
        ...
        file.deleteOnExit();
        assertEquals(Responses.successfulUserCreation + System.lineSeparator() + Responses.successfulLogin + System.lineSeparator() + "Export/Import Menu" + System.lineSeparator(), outputStreamCaptor.toString());
    }
    ...
    public void menuEnterExport() {
        ...
        loginMenu.run("user login -u menuEnterExportT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
    ...
    public void menuEnterScoreboard() {
        ...
        loginMenu.run("user login -u menuEnterScoreboardT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
    ...
    public void menuEnterInvalid() {
        ...
        new LoginMenu().run("user login -u menuEnterInvalidT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
    ...
    public void invalidCommand() {
        ...
        new LoginMenu().run("user login -u invalidCommandT1yl0rSw1ftW4$B0rnIn1989 -p 1989");
